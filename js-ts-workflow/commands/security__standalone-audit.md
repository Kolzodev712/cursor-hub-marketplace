...
2. **Review:** Walk through code vulnerabilities, dependencies (run `npm audit` or equivalent if available), secrets and auth, crypto usage, misconfiguration, and CI/CD. Classify each finding by severity.
