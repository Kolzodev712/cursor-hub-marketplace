...
2. **Understand the ask:** Identify the problem, scope, and any stated constraints (state, providers, security).
3. **Challenge:** List 2–4 critical questions or risks (missing constraints? alternatives? state/destroy implications?).
...
6. **Verification:** Define how we will verify the design (terraform validate, plan, no sensitive leakage).
