...
- What modules/resources exist and how they are composed
- What goes where and why (state, providers, data flow)
- Inputs/outputs and variable contracts
- State and lifecycle assumptions (e.g. no accidental destroy)
