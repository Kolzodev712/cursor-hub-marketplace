...
**Follow with:** Bugfix Step 2 — Proposed solution (`/python-bugfix__wf-2-proposed-solution`), then Step 3 — Resolution (`/python-bugfix__wf-3-resolution`).
...
This workflow uses its own design logs; it does not assume a log from python-design-review or python-implementation.
