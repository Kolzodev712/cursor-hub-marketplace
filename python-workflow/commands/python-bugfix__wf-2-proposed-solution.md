...
**Use after:** Bugfix Step 1 — Investigation (`/python-bugfix__wf-1-investigation`). Propose how to fix the bug and document trade-offs before implementing.

**Follow with:** Bugfix Step 3 — Resolution (`/python-bugfix__wf-3-resolution`).
